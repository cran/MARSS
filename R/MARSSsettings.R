...
alldefaults$BFGS = list(
      ...
      model=list(Z="identity", A="scaling", R="diagonal and equal", B="identity", U="unconstrained", Q="diagonal and unequal", x0="unconstrained", V0="zero"),
      miss.value=NA,  
      control=list(maxit=5000, kf.x0="x00", diffuse=FALSE, MCInit=FALSE, numInits = 500, numInitSteps = 10, boundsInits=list(B=c(0,1), U=c(-1,1), logQ = c(log(1.0e-05),log(1.0)), Z=c(0,1), A=c(-1,1), logR = c(log(1.0e-05),log(1.0)) ),
...
allowed$kem = list(
        A=c("scaling", "unconstrained", "unequal", "equal", "zero", "ones"),
        B=c("identity", "zero", "unconstrained", "unequal", "diagonal and unequal", "diagonal and equal", "equalvarcov"),
        Q=c("identity", "zero", "unconstrained", "unequal", "diagonal and unequal", "diagonal and equal", "equalvarcov"),
        R=c("identity", "zero", "unconstrained", "unequal", "diagonal and unequal", "diagonal and equal", "equalvarcov"),
        U=c("unconstrained", "equal", "unequal", "zero", "ones"),
        x0=c("unconstrained", "equal", "unequal", "zero", "ones"),
        V0=c("identity", "zero", "unconstrained", "unequal", "diagonal and unequal", "diagonal and equal", "equalvarcov"),
        Z=c("identity","unconstrained", "unequal", "diagonal and unequal", "diagonal and equal", "equalvarcov", "ones"),
        factors = c("Z"),
        matrices = c("A","B","Q","R","U","x0","Z","V0") 
      )
