###################################################
### code chunk number 17: Cs_dlm-Innov-t-test
###################################################
...
###################################################
### code chunk number 14: Cs_dlm-forecast-errors
###################################################
# forecast errors
innov = kf.out$Innov
...
###################################################
### code chunk number 19: Cs_plot-dlm-ACF
###################################################
...
###################################################
### code chunk number 12: Cs_plot-dlm-Forecast-Logit
###################################################
...
###################################################
### code chunk number 13: Cs_plot-dlm-Forecast-Raw
###################################################
...
###################################################
### code chunk number 16: Cs_plot-dlmQQ
###################################################
# use layout to get nicer plots
layout(matrix(c(0,1,1,1,0),1,5,byrow=TRUE))
...
###################################################
### code chunk number 4: Cs_plotdata
###################################################
...
###################################################
### code chunk number 9: Cs_plotdlm1
###################################################
...
###################################################
### code chunk number 2: Cs_read.in.data
###################################################
# load the data
data(SalmonSurvCUI)
# get time indices
...
###################################################
### code chunk number 8: Cs_univ.DLM.fit
###################################################
# fit univariate DLM
...
###################################################
### code chunk number 11: Cs_univ.DLM.fore.Var
###################################################
...
###################################################
### code chunk number 10: Cs_univ.DLM.fore.mean
###################################################
...
###################################################
### code chunk number 7: Cs_univ.DLM.list
###################################################
...
###################################################
### code chunk number 6: Cs_univ.DLM.obs
###################################################
# for observation eqn
...
###################################################
### code chunk number 5: Cs_univ.DLM.proc
###################################################
# for process eqn
...
###################################################
### code chunk number 3: Cs_z.score
###################################################
