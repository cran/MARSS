...
###################################################
### code chunk number 31: Cs7_B.covar
###################################################
B=matrix(list(0),5,5)
...
###################################################
### code chunk number 32: Cs7_C.covar
###################################################
C=matrix(list("C11","C21",0,0,0),5,1)


###################################################
### code chunk number 34: Cs7_Q.covar
###################################################
Q=matrix(list(0),5,5); 
...
###################################################
### code chunk number 33: Cs7_R.covar
###################################################
R=matrix(list(0),5,5)
...
###################################################
### code chunk number 28: Cs7_add.covar.model.3
###################################################
...
###################################################
### code chunk number 30: Cs7_add.fish.to.data
###################################################
...
###################################################
### code chunk number 13: Cs7_bad.data.2 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 10: Cs7_cov.wolf.moose.model
###################################################
...
###################################################
### code chunk number 11: Cs7_cov.wolf.moose.model
###################################################
kem.3=MARSS(z.royale.dat[,2:53], model=royale.model.3)


###################################################
### code chunk number 15: Cs7_figplank
###################################################
...
###################################################
### code chunk number 12: Cs7_figwolfcov
###################################################
...
###################################################
### code chunk number 35: Cs7_fit.covar.model
###################################################
...
###################################################
### code chunk number 6: Cs7_fit.model
###################################################
...
###################################################
### code chunk number 17: Cs7_fit.plank.model.0
###################################################
...
###################################################
### code chunk number 21: Cs7_fit.plank.model.1
###################################################
...
###################################################
### code chunk number 24: Cs7_fit.plank.model.2
###################################################
#model 2
...
###################################################
### code chunk number 26: Cs7_fit.plank.model.3
###################################################
#model 3
...
###################################################
### code chunk number 14: Cs7_load.plankton.data
###################################################
...
###################################################
### code chunk number 2: Cs7_load.wolf.data
###################################################
royale.dat = log(t(isleRoyal[,2:3]))


###################################################
### code chunk number 38: Cs7_logLik.variates
###################################################
tmp=kem.plank.5
tmp$marss$data[5,]=NA
...
###################################################
### code chunk number 29: Cs7_plank.model.4
###################################################
kem.plank.4= MARSS(d.plank.dat, model=plank.model.4)


###################################################
### code chunk number 16: Cs7_plankton.model
###################################################
Z="identity"
U="zero"
B="unconstrained"
...
###################################################
### code chunk number 9: Cs7_prep.cov.wolf.moose
###################################################
...
###################################################
### code chunk number 27: Cs7_prep.covariates
###################################################
#transpose to make time go across columns
#drop=FALSE so that R doesn't change our matrix to a vector
...
###################################################
### code chunk number 18: Cs7_print.B.0
###################################################
...
###################################################
### code chunk number 22: Cs7_print.B.1
###################################################
#Cleaning up the B matrix for printing
...
###################################################
### code chunk number 25: Cs7_print.B.2
###################################################
#Cleaning up the B matrix for printing
...
###################################################
### code chunk number 19: Cs7_print.B.Ives
###################################################
#Cleaning up the B matrix for printing
...
###################################################
### code chunk number 36: Cs7_print.B
###################################################
#Cleaning up the B matrix for printing
...
###################################################
### code chunk number 8: Cs7_print.wolf.B
###################################################
...
###################################################
### code chunk number 20: Cs7_test.rm.NAs (eval = FALSE)
###################################################
