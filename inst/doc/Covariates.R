###################################################
### code chunk number 13: Covar_C-constrained
###################################################
...
###################################################
### code chunk number 14: Covar_C-constrained2
###################################################
C = "unconstrained"


###################################################
### code chunk number 5: Covar_covar-model-0
###################################################
...
###################################################
### code chunk number 6: Covar_covar-model-0b
###################################################
Q = "unconstrained"
...
###################################################
### code chunk number 7: Covar_covar-model-1
###################################################
...
###################################################
### code chunk number 8: Covar_covar-model-1c
###################################################
...
###################################################
### code chunk number 9: Covar_covar-model-2
###################################################
x0 = dat[,1,drop=FALSE]
model.list$tinitx = 1
model.list$x0 = x0
...
###################################################
### code chunk number 10: Covar_covar-model-5
###################################################
...
###################################################
### code chunk number 24: Covar_diag-code (eval = FALSE)
###################################################
## for(i in 1:3) {
##   dev.new()
...
###################################################
### code chunk number 16: Covar_fit-month-factor-with-MARSS
###################################################
...
###################################################
### code chunk number 2: Covar_load-plankton-data
###################################################
...
###################################################
### code chunk number 15: Covar_month-factor-marss-params
###################################################
...
###################################################
### code chunk number 25: Covar_plot-acf-1
###################################################
...
###################################################
### code chunk number 26: Covar_plot-acf-2
###################################################
par(mfrow=c(5,2), mai=c(0.1,0.5,0.2,0.1), omi=c(0.5,0,0,0))
for(i in 1:5) {
...
###################################################
### code chunk number 27: Covar_plot-acf-2
###################################################
par(mfrow=c(5,2), mai=c(0.1,0.5,0.2,0.1), omi=c(0.5,0,0,0))
for(i in 1:5) {
...
###################################################
### code chunk number 22: Covar_plot-seas-effects
###################################################
...
###################################################
### code chunk number 17: Covar_poly-month-factor
###################################################
...
###################################################
### code chunk number 18: Covar_seasonal-effect-poly
###################################################
...
###################################################
### code chunk number 21: Covar_seasonal-effects-fourier
###################################################
...
###################################################
### code chunk number 20: Covar_seasonal-fourier-fit
###################################################
...
###################################################
### code chunk number 19: Covar_seasonal-fourier
###################################################
...
###################################################
### code chunk number 12: Covar_set-up-month-factors
###################################################
# number of "seasons" (e.g., 12 months per year)
period = 12
# first "season" (e.g., Jan = 1, July = 7)
...
###################################################
### code chunk number 11: Covar_set-up-seasonal-dat
###################################################
years = fulldat[,"Year"]>=1965 & fulldat[,"Year"]<1975
...
###################################################
### code chunk number 23: Covar_show-aics
###################################################
...
###################################################
### code chunk number 3: Covar_z-score-covar-data
###################################################
covariates = rbind(
