###################################################
### code chunk number 21: Cs4_compare.mods.2n3
###################################################
...
###################################################
### code chunk number 35: Cs4_covar-AICs
###################################################
...
###################################################
### code chunk number 33: Cs4_fit.covar.echo (eval = FALSE)
###################################################
...
###################################################
### code chunk number 16: Cs4_fit.data.echo
###################################################
kemz.3 = MARSS(dat.z, model=dfa.model, control=cntl.list)


###################################################
### code chunk number 25: Cs4_getbestmodel
###################################################
# get the "best" model
...
###################################################
### code chunk number 30: Cs4_plotbestfits
###################################################
...
###################################################
### code chunk number 5: Cs4_plotdata
###################################################
...
###################################################
### code chunk number 28: Cs4_plotfacloadings
###################################################
spp = rownames(dat.z)
minZ = 0.05
...
###################################################
### code chunk number 18: Cs4_plotfits
###################################################
fit = kemz.3
spp = rownames(dat.z)
par(mfcol=c(3,2), mar=c(3,4,1.5,0.5), oma=c(0.4,1,1,1))
...
###################################################
### code chunk number 29: Cs4_plottrends
###################################################
# get ts of trends
...
###################################################
### code chunk number 10: Cs4_print
###################################################
print(R)


###################################################
### code chunk number 7: Cs4_print.Z
###################################################
print(Z)


###################################################
### code chunk number 2: Cs4_read.in.data
###################################################
# load the data
...
###################################################
### code chunk number 27: Cs4_rotations
###################################################
...
###################################################
### code chunk number 31: Cs4_set-up-covar
###################################################
...
###################################################
### code chunk number 14: Cs4_set.model
###################################################
...
###################################################
### code chunk number 8: Cs4_set.up.QR
###################################################
Q = B = diag(1,3)


###################################################
### code chunk number 9: Cs4_set.up
###################################################
R.vals = list(
"r11",0,0,0,0,0,
0,"r22",0,0,0,0,
...
###################################################
### code chunk number 11: Cs4_set.up.R.short
###################################################
R = "diagonal and unequal"


###################################################
### code chunk number 12: Cs4_set.up.U
###################################################
...
###################################################
### code chunk number 6: Cs4_set.up.Z
###################################################
Z.vals = list(
"z11",  0  ,  0  ,
"z21","z22",  0  ,
...
###################################################
### code chunk number 23: Cs4_set.up.many.trends.echo (eval = FALSE)
###################################################
...
###################################################
### code chunk number 20: Cs4_set.up.two.trends.echo (eval = FALSE)
###################################################
...
###################################################
### code chunk number 13: Cs4_set.up.x0
###################################################
V0 = diag(5,3)


###################################################
### code chunk number 3: Cs4_transpose.data
###################################################
...
###################################################
### code chunk number 26: Cs4_varimax
###################################################
...
###################################################
### code chunk number 4: Cs4_z.score
###################################################
